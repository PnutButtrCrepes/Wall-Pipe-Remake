...
public class HazardManager extends Entity
{
    ...
    {
	BufferedReader hazardsFileInputStream = new BufferedReader(new InputStreamReader(Gdx.files.internal("LevelHazards.txt").read()));
	String line = "";
	try
	{
    ...
    {
	//int blankStationaryBlocks, int blankMovingBlocks, int bathtubs, int unidirectionalBlocks, int fourCorners, int teleporters, int pointPipes, int sinks
